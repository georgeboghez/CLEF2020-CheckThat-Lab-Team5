...
class TestCrawler(unittest.TestCase):
    def test_getTweets(self):
        ...
        self.assertFalse(crawler.getTweets("jdgsfjdgdiushighdoihgdioghdiodgh","2020-03-20",2),"A fost gasit un tweet care contine jdgsfjdgdiushighdoihgdioghdiodgh")

    def test_getTweetsByUsers(self):
        self.assertTrue(crawler.getTweetsByUsers(["NASA"], "2020-03-20", 2), "N-au fost gasite 2 tweet-uri de la utilizatorii NASA, Samsung.")
        self.assertTrue(crawler.getTweetsByUsers(["elonmusk","JoeBiden"], "2020-03-20", 2), "N-au fost gasite 10 tweet-uri de la utilizatorii elonmusk, JoeBiden.")
